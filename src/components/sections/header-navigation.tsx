...
export const HeaderNavigation = () => {
  ...
  const { data: session, isPending, refetch, signOut: sessionSignOut } = useSession();
  ...
  const handleSignOut = async () => {
    try {
      ...
      // Use authClient.signOut() or sessionSignOut()
                      ...
                      <div className="absolute right-0 top-full mt-2 w-48 rounded-md border border-border bg-card shadow-lg">
                        <div className="p-2">
                          ...
                          <button 
                            ...
                            className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm text-red-400 transition-colors hover:bg-muted"
                          >
              ...
              <div className="space-y-2">
                {session?.user && coinBalance !== null && (
                  <button 
                    ...
                    className="flex w-full items-center justify-between rounded-md border border-border bg-background px-4 py-2"
                  >
