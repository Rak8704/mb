...
// Updated: Autoplay slideshow at the top (uses assets from /public folder)
const slides = [
  '/Nicebet_Extra_Bonus_Homepage_Banner_15_Sep_2025_Tablet_extra_bonus.webp',
  // Agar aapke paas aur images hain public folder mein to unke naam yahan add karein
  '/slide1.webp',
  '/slide2.webp',
  '/slide3.webp',
  '/slide4.webp',
